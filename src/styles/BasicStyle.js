...
import { padding, margin, themeColor, fonts } from "./Theme";
...
export default StyleSheet.create({
    ...
    textLighter: {
        color: themeColor.textLighter
    },
    textWarning: {
        color: themeColor.warning
    },
    textLightPurple: {
        color: themeColor.textLightPurple
    },
    // ========= Color ================= //
    colorWhite: {
        color: themeColor.white
    ...
    colorThin: {
        color: themeColor.grayThin
    },
    colorSkyBlue: {
        color: themeColor.visitorChat
    },
    colorTextLightGray: {
        color: themeColor.textLightGray
    },
    // ========= Background Color ================= //
    backgroundColorPrimaryPurple: {
    ...
    backgroundColorSkyBlue: {
        backgroundColor: themeColor.visitorChat
    },
    backgroundOverlay4: {
